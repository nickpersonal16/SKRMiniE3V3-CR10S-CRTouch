...
#define STRING_CONFIG_H_AUTHOR "(Nick Johnson)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "CR-10S - Testing CRTouch"
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_SENSOR_DEBUG true
